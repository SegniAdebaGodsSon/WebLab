...
var browserInfo = document.querySelector('.browserInfo');
var screenInfo = document.querySelector('.screenInfo');
var historyInfo = document.querySelector('.historyInfo'); // Display the BOM Information on the innerHTML of the elements

locationInfo.addEventListener('click', function (e) {
...
browserInfo.addEventListener('click', function (e) {
  if (e.target.tagName === 'A') {
...
screenInfo.addEventListener('click', function (e) {
  if (e.target.tagName === 'A') {
...
historyInfo.addEventListener('click', function (e) {
  if (e.target.tagName === 'A') {
