...
var id = Number(urlParams.get('id')); //DB

var DB; // Add Event Listener [on Load]

document.addEventListener('DOMContentLoaded', function () {
  // create the database
  var TasksDB = indexedDB.open('tasks', 1); // if there's an error
  ...
  TasksDB.onsuccess = function () {
    console.log('Database Ready'); // save the result

    DB = TasksDB.result; // display the Task 
  ...
  function updateTask(e) {
    e.preventDefault();
    console.log(id); // Check empty entry
